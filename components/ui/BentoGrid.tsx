...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    const email = "lauroportfolio@gmail.com"
    ...
    >
      <div className={`${id === 6 && 'flex justify-center'} h-full`}>
        ...
        <div className={cn(
          ...
          <div className="font-sans text-[#c1c2d3] text-sm md:text-xs lg:text-base z-10 font-extralight">
            {description}
          </div>
          ...
          {id === 3 && (
            <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2">
              <div className="flex flex-col gap-3 lg:gap-8">
                {["TailwindCSS", "JavaScript", "MongoDB"].map((item) => (
              ...
              <div className="flex flex-col gap-3 lg:gap-8">
                <span className="px-3 py-4 rounded-lg text-center bg-[#10132E]" />
                {["Next.js", "TypeScript", "React.js"].map((item) => (
                  <span key={item} className="py-2 lg:py-4 lg:px-3 px-3 text-xs lg:text-base opacity-50 lg:opacity-100 rounded-lg text-center bg-[#10132E]">
                    {item}
                  </span>
                ))}
          ...
          {id === 6 && (
            <div className="mt-5 relative">
              <div className={`absolute -bottom-5 right-0 ${copied ? "block" : "block"}`}>
                {copied && (
                  <Lottie options={{
                    loop: false, // Não queremos que fique repetindo infinitamente
                    autoplay: true,
