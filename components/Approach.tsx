    ...
    return (
        <section className="w-full py-20">
            <h1 className="heading">
                {t.approach.prefix} <span className="text-purple">{t.approach.highlight}</span>
            </h1>
            <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
                <Card
                    title={t.approach.card1Title}
                    icon={<AceternityIcon order={t.approach.card1Order} />}
                    description={t.approach.card1Desc}
                >
                    <CanvasRevealEffect
                        animationSpeed={5.1}
                ...
                <Card
                    ...
                    icon={<AceternityIcon order={t.approach.card2Order} />}
                    description={t.approach.card2Desc}
                >
                    <CanvasRevealEffect
                        animationSpeed={3}
                ...
                <Card
                    ...
                    icon={<AceternityIcon order={t.approach.card3Order} />}
                    description={t.approach.card3Desc}
                >
                    <CanvasRevealEffect
                        animationSpeed={3}
    ...
    return (
        <div>
            <button className="relative inline-flex h-12 overflow-hidden rounded-full p-px focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
                ...
                <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-slate-950 px-3 py-1 text-sm font-medium lg:px-5 lg:py-2 lg:text-2xl md:px-5 md:py-2 md:text-2xl lg:font-bold text-white backdrop-blur-3xl">
                   {order}
                </span>
            </button>
        </div>
